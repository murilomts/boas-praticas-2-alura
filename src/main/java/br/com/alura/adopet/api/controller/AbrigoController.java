...
public class AbrigoController {
    ...
    @GetMapping
    public ResponseEntity<List<RetornoAbrigoDTO>> listar() {
        List<RetornoAbrigoDTO> abrigos = abrigoService.listar();
    ...
    public ResponseEntity<List<RetornoPetDTO>> listarPets(@PathVariable String idOuNome) {
        try {
            List<RetornoPetDTO> petsDoAbrigo = abrigoService.listarPetsDoAbrigo(idOuNome);
