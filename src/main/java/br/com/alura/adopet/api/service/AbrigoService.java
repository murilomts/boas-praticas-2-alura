...
import br.com.alura.adopet.api.dto.RetornoAbrigoDTO;
...
public class AbrigoService {
    ...
    public List<RetornoAbrigoDTO> listar() {
        return abrigoRepository.findAll().stream()
                .map(RetornoAbrigoDTO::new)
                .toList();
    }
    ...
    public List<RetornoPetDTO> listarPetsDoAbrigo(String idOuNome) {
